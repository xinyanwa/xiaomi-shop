        ...
        <div class="register">
                ...
                <div class="register-from">
                    <el-form>
                        <div class="register-from-region">
                            ...
                            <el-select v-model="value" class="register-region" filterable>
                                <el-option-group
                        ...
                        <el-button class="register-submit" type="submit">立即注册</el-button>
                    </el-form>
                </div>
                <div class="msg">
                    <p>
            ...
            <div class="register-footer">
                <div class="register-footer-language">
                    <ul>
                        <li v-for="(item, index) in footerLanguage" :key="index">
                            <span>
                                <a href="">
                                    {{item}}
                                </a>
